...
public class StepView extends View {
    ...
    private int lineDoneColor = Color.parseColor("#0F4C81");
    private int lineDefaultColor = Color.parseColor("#31b3e4");
    private int circleSelectColor = Color.parseColor("#0F4C81");
    private int circleDefaultColor = Color.parseColor("#31b3e4");
    private int textSelectColor = Color.parseColor("#0F4C81");
    private int textDefaultColor = Color.parseColor("#31b3e4");
